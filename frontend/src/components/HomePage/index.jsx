...
export default function HomePage() {
    return (
        <section className="flex flex-col justify-center items-center w-full">
            ...
            <div>
                <p className="welcome-message font-mono text-[12px] lg:text-[24px]">Welcome to Jae Ahn-Benton's website.</p>
            </div>
            <div className="code-greeting w-3/4 max-w-[600px] border-black border-4 bg-zinc-700 text-zinc-200 rounded-3xl mx-12 pl-12 my-5 text-[12px] lg:text-[24px]">
